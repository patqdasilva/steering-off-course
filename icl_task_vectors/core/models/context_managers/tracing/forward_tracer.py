...
from core.models.context_managers.tracing.forward_trace import (
    ForwardTrace,
    ResidualStream,
)
from core.models.utils.llm_layers import (
    get_embedding_layer,
    get_layers,
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        ...
        if exc_type is None:
            ...
            if self._with_submodules:
                self._forward_trace.attentions = torch.stack(
                    self._forward_trace.attentions
                ).transpose(0, 1)
            else:
    ...
    def _register_forward_hooks(self):
        ...
        if self._with_submodules:
            ...
            for i, attn_layer in enumerate(self._attn_layers):
                ...
                attn_attentions_hook = attn_layer.register_forward_hook(
                    store_attentions(i)
                )
