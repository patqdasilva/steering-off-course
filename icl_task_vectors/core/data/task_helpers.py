...
ALL_TASKS = {
    ...
    "algorithmic_list_min": {
        ...
        "task_kwargs": {
            "operation": "min",
            "list_lenghts": range(2, 5),
            "elements_space": list(string.digits),
        },
    },
    ...
    "algorithmic_to_upper": {
        ...
        "task_kwargs": {
            "operation": "to_upper",
            "input_space": list(string.ascii_lowercase),
        },
    },
    "algorithmic_to_lower": {
        ...
        "task_kwargs": {
            "operation": "to_lower",
            "input_space": list(string.ascii_uppercase),
        },
    },
    "algorithmic_char_to_int": {
        ...
        "task_kwargs": {
            ...
            "input_space": list(string.ascii_lowercase[:9]),
        },
    },  # low performance
    "algorithmic_int_to_char": {
        "task_type": "token_operation",
        "task_kwargs": {
            "operation": "int_to_char",
            "input_space": list(string.digits[1:]),
        },
    },
    # Translation
    "translation_fr_en": {
    ...
    "linguistic_present_simple_gerund": {
        "task_type": "mapping",
        "task_kwargs": {
            "mapping_type": "linguistic",
            "mapping_name": "present_simple_gerund",
        },
    },
    "linguistic_present_simple_past_simple": {
        ...
        "task_kwargs": {
            "mapping_type": "linguistic",
            "mapping_name": "present_simple_past_simple",
        },
    },
    "linguistic_present_simple_past_perfect": {
        ...
        "task_kwargs": {
            "mapping_type": "linguistic",
            "mapping_name": "present_simple_past_perfect",
        },
    },
    ...
    "knowledge_location_continent": {
        ...
        "task_kwargs": {
            "mapping_type": "knowledge",
            "mapping_name": "location_continent",
            "allow_prefix": True,
        },
    },
    "knowledge_location_religion": {
        ...
        "task_kwargs": {
            "mapping_type": "knowledge",
            "mapping_name": "location_religion",
            "allow_prefix": True,
        },
    },
    # "sentiment": {
...
def get_task(
    task_type: str, task_kwargs: Dict[str, str], tokenizer: PreTrainedTokenizer
) -> Task:
...
def get_all_tasks(tokenizer: PreTrainedTokenizer) -> Dict[str, Task]:
    tasks = {
        task_name: get_task_by_name(tokenizer, task_name) for task_name in ALL_TASKS
    }
    return tasks
