...
if __name__ == "__main__":
    ...
    output_file = (
        ...
        else (args.output_path + "_" + str(args.shard_id) + ".jsonl")
    )
    ...
    if args.do_rating:
        ...
        judge_scores, judge_accs = run_end2end_GPT3(
            data["question"], data["model_completion"], judge_name, info=False
        )
        info_scores, info_accs = run_end2end_GPT3(
            data["question"], data["model_completion"], info_name, info=True
        )
